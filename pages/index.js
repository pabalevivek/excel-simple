    ...
    <div style={{ fontFamily: '"Inter", sans-serif', background: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div className="container">
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto 50px', textAlign: 'center' }}>
          ...
          {/* TITLE with v2.0 Indicator */}
          <div style={{ marginBottom: '10px', fontSize: '3rem' }}>🤖</div>
          <h1 style={{ fontSize: '3rem', fontWeight: '800', color: '#0f172a', marginBottom: '10px', letterSpacing: '-1.5px', lineHeight: '1.1' }}>
            Find the Perfect Model
          </h1>
          <div style={{ color: '#94a3b8', fontSize: '0.9rem', marginBottom: '30px', fontWeight: 'bold' }}>v2.0 (No Sidebar)</div>
                ...
                <div style={{ 
                  ...
                  {!optOutput ? (
                    <>
                      ...
                      />
                      <button onClick={handleOptimize} style={{ width: '100%', padding: '15px', background: 'white', border: 'none', borderRadius: '12px', color: '#0f172a', fontWeight: '800', cursor: 'pointer', fontSize: '1rem', transition: 'filter 0.2s', boxShadow: '0 4px 15px rgba(255,255,255,0.1)' }}>
                        {isOptimizing ? 'Optimizing...' : 'Generate Pro Prompt'}
                      </button>
                    </>
                  ) : (
                    <div>
                      <div style={{ background: '#0f172a', padding: '20px', borderRadius: '12px', marginBottom: '20px', maxHeight: '300px', overflowY: 'auto', fontSize: '0.95rem', lineHeight: '1.6', border: '1px solid #334155', color: '#cbd5e1', whiteSpace: 'pre-wrap' }}>{optOutput}</div>
